...
def calculate_travel_time(api_key, address, temporary_destination):
...
class Distance():
    ...
    def __init__(self, api_key, origin_a, destination, radius=5000, search="restaurants", suggested_length=8, **friend_origins):
    ...
    def validate_address(self, address):
        return validate_address(self.api_key, address)
    ...
    def get_directions_to_midpoint_places(self, many=False):
        ...
        if places:
            ...
            for idx, place in enumerate(places[:self.suggested_length]):
                ...
                travel_time_A = calculate_travel_time(self.api_key, self.origin_a, place['vicinity'])
                ...
                if not many:
                    ...
                    travel_time = calculate_travel_time(self.api_key, address, place['vicinity'])
